...
const SearchResults = (props) => {
    ...
    const handleFilterChange = (filterName, filterValue) => {
        ...
        Object.entries(filters).forEach(([key, value]) => {
            if (key === "amenity" && Array.isArray(value)) {
    ...
    const handleAmenityChange = (id) => {
        ...
        if (isSelected) {
            ...
            newSelectedAmenities = [...selectedAmenities, id];
        }

        // Save state to the history state
        router.remember("selectedAmenities", newSelectedAmenities);

        // Set the new value of the selectedAmenities state variable
        setSelectedAmenities(newSelectedAmenities);

        // Call the handleFilterChange function
        handleFilterChange("amenity", newSelectedAmenities);
    };
                            ...
                            <div className="pl-[20px] [@media(max-width:480px)]:pl-0">
                                ...
                                <div className="mt-[2rem]">
                                    ...
                                    <input
                                        ...
                                        className="mt-2"
                                        value={
                                            selectedQueries.filter?.max_price ||
                                            0
                                        }
